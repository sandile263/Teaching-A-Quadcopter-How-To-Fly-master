...
# REVISED DATE: -                                              #
# PURPOSE: This file contains the simulator for the quadcopter #
################################################################
...
############################################
# Class describing the physics to simulate #
############################################
...
class PhysicsSim():
    ...
    def get_moments(self, thrusts):
        ...
        moments = thrust_moment - drag_moment
        return moments

    # Calculate propagation wind speed:
    ...
    # Calculate net thrust (thrust - drag) based on velocity of propeller and incoming power:
    ...
    # Calculate next timestep elements:
